...
description: simple app following @cheerlights stream on twitter and send the corresponding hex color code to a MQTT broker.
...
stream.on('error', function(error) {
  console.error('Error on twitter stream');
  throw error;
});
